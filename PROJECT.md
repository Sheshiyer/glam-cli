...
This is the canonical project entry point for the `gram-cli`
...
- Repository: `gram-cli`
- Registry WorkObject: `program:operator-utilities` (`Operator Utilities`, kind: program)
- GitHub: `Sheshiyer/glam-cli` (identity_status: pending-teamforge-verification)
...
`pytest` is the current deterministic verification
command.
