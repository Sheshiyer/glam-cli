...
# Formula for installing glam-cli via Homebrew.
class GlamCli < Formula
  include Language::Python::Virtualenv

  desc "Instagram CLI for browser-authenticated profile, saved, story, and highlight downloads"
  ...
  test do
    assert_match "glam", shell_output("#{bin}/glam --version")
    assert_match "Instagram CLI", shell_output("#{bin}/glam --help")
    assert_match "Instagram CLI", shell_output("#{bin}/gram --help")
  end
end
